...
The Azure Infra Prompt Kit is a **read-only UI** that displays content generated by coding agents. When users run slash commands in a coding agent (OpenCode, Claude Code, or GitHub Copilot), the agent creates markdown and JSON files that the UI automatically displays.
