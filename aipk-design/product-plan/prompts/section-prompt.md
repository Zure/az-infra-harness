...
- **SECTION_NAME** = [Human-readable section name, e.g., "Application Definition"]
- **SECTION_ID** = [Folder name, e.g., "application-definition"]
- **NN** = [Milestone number with leading zero, e.g., "02"]
