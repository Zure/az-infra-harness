...
console.log('  Creating infra/bicep and infra/tf folders...')
copyDir(path.join(backupDir, 'bicep'), path.join(dataDir, 'bicep'))
copyDir(path.join(backupDir, 'tf'), path.join(dataDir, 'tf'))
...
console.log('   ✓ Export completed (infra/bicep/, infra/tf/)')
console.log('')
