...
This project is an interactive planning tool for Azure infrastructure. A coding agent generates markdown and JSON files in `infra/` which are displayed in a read-only UI.
