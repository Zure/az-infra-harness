...
This skill documents the end-to-end deployment strategy for the application. It generates `src/data/application-architecture/deployment-strategy.md` which serves as the reference for CI/CD pipeline design and IaC deployment automation.
...
Check whether `src/data/application-architecture/deployment-strategy.md` already exists.

Also scan the codebase for existing CI/CD configuration:
- `.github/workflows/` — GitHub Actions workflows
- `azure-pipelines.yml` — Azure Pipelines
- `.gitlab-ci.yml` — GitLab CI
- `src/data/context/development-context.md` — already-captured development context (reuse this!)
...
**Important:** First check `src/data/context/development-context.md` — if it exists, many answers may already be captured there. Pre-populate what you can from that file and ask the user to confirm rather than asking from scratch.
...
**Target location:** `src/data/application-architecture/deployment-strategy.md`
...
📄 File location: src/data/application-architecture/deployment-strategy.md
...
- **Sample output**: `src/data/application-architecture/deployment-strategy.md`
- **Related data**: `src/data/context/development-context.md`
...
- ✅ File created at `src/data/application-architecture/deployment-strategy.md`
