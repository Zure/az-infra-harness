...
| `/application-components` | `infra/application-definition/application-components.md` | Markdown |
...
**More examples:** See `infra/application-definition/application-components.md`
...
```bash
# Starting from infra/application-definition/
